...
function Home() {
	...
	const createEvents = async (event) => {
		let ok = await createEventsService(calendar, classes)
		console.log(ok);
	}
	...
	// 									);
	// 									//console.log(startTime)
	// 									let indexHourStart = startTime.indexOf(
	// 										'h'
	// 									);
	// 									//console.log(indexHourStart, )
	// 									let hoursStart = '';
	...
	// 		event,
	// 		'rtpgcqtr8n8sl3mo8kepoc0l1c@group.calendar.google.com'
	// 	);
	// };
			...
			<div>
				{classes[0] === undefined ? (
					...
					<div>
						...
						<button onClick={createEvents}>Send to Google Calendar</button>
					</div>
				)}
			</div>
		</div>
